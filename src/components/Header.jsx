    ...
    return (
        <div id='home' className='header'>
            ...
            <nav className='header-nav' id="navbar" ref={navRef}>
                ...
                <a href="https://api.whatsapp.com/send/?phone=5543999999999&text&type=phone_number&app_absent=0" onClick={showNavBar} target="_blank"><img width="30px" src={wppLogo} alt="botão que direciona para o WhatsApp" /></a>
